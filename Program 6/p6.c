...
/*
Write an OpenMP program for Word search in a file and illustrate the performance using different sizes of file.
*/
...
void main(){
	...
	printf("Output for words search program using openmp : \n");
	for(i=0;i<COUNT;i++){
